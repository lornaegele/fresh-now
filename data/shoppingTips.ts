export const shoppingTips: HealthTip[] = [
  ...
  {
    id: "009",
    name: "Marktbesuch lohnt sich",
    content:
      "Auf Wochenmärkten finden Sie oft saisonales Gemüse direkt vom Bauernhof. Die Produkte sind frischer und oft preiswerter.",
    emoji: "🛍️",
  },
  {
    id: "011",
    name: "Achten Sie auf Regionalität",
    content:
      "Saisonales Gemüse aus der Region ist nicht nur umweltfreundlich, sondern schmeckt oft besser und enthält mehr Nährstoffe.",
    emoji: "📍",
  },
  {
    id: "013",
