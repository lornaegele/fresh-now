export const vegetablesDE: Vegetable[] = [
  ...
  },
  {
    ...
    info: "Pastinaken sind Wurzelgemüse, die eine nussige Süße und einen milden Geschmack haben. Sie sind besonders in der kalten Jahreszeit beliebt und können als Beilage oder in Eintöpfen verwendet werden.",
    image: "https://example.com/images/parsnip.jpg",
    season: ["November", "December", "January", "February"],
    vitamins: [
      { name: "Vitamin C", amount: "17.0 mg", percentage: "20%" },
      { name: "Vitamin A", amount: "900 IU", percentage: "18%" },
    ],
    nutrients: {
      Ballaststoffe: 4.0,
      Eiweiß: 1.5,
    ...
    benefits: [
      "Stärkt das Immunsystem mit Vitamin C",
      "Fördert eine gesunde Haut durch Vitamin A",
      "Hilft bei der Verdauung durch Ballaststoffe",
    ],
    regionAvailability: ["Deutschland", "Frankreich", "Niederlande"],
    storageTips: "Kühl und trocken lagern.",
    recipes: ["Pastinakenpüree", "Pastinaken-Curry"],
  },
  {
    id: "veg040",
    name: "Spargel",
